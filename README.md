...
git clone --recursive https://github.com/EricWRogers/computer-graphics-starter-code.git
-or-
git clone --recursive git@github.com:EricWRogers/computer-graphics-starter-code.git
